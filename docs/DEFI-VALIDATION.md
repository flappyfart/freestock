...
- Read-only Morpho coverage is one tracked vault and five verified listed USDG markets. Fallback snapshots carry timestamps; deployment does not enable real money or stock transactions.
