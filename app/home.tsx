...
export default function Home() {
  ...
  useEffect(() => {
    const followDemoLink = () => {
      ...
      if (view && ['setup', 'results', 'activity'].includes(view))
        openDemo(view as DemoView);
      else if (
        ['#practice-results', '#demo-results', '#positions'].includes(hash)
      )
        openDemo('results');
      ...
      <div className="home-flow">
        <section className="home-hero">
          <div className="home-hero-copy">
            <span className="earn-eyebrow">
              AGENTIC LENDING. YOUR STOCK PICKS.
            </span>
            <h1>
              Keep lending.
              <br />
            ...
            <p>
              Give your lending a plan. Agentic Lending checks your available
              gains and helps you decide when to put them toward the stock
              tokens you choose.
            </p>
            ...
            <p className="home-hero-note">
              Live on Robinhood Chain · Your wallet stays in control
              <br />
          ...
          <div className="home-stock-scene" aria-hidden="true">
            ...
            <img
              ...
              alt=""
            />
            <span className="home-stock-caption">
              Earnings, meet your stock picks.
            </span>
          </div>
        </section>
        <section className="home-agentic" aria-labelledby="agentic-title">
          <div className="home-agentic-copy">
            ...
            <small>
              Recommendation mode · Rule-based checks · You approve transactions
            </small>
          </div>
          <div
            className="home-agentic-flow"
            aria-label="How Agentic Lending works"
          >
            <div>
              <ScanLine size={21} />
              <span>
                ...
                <small>
                  Live balance, principal baseline and available gains.
                </small>
              </span>
            </div>
            <div>
              ...
              <span>
                ...
                <small>
                  Your stock picks, conversion minimum and gas budget.
                </small>
              </span>
            </div>
            <div>
              ...
              <span>
                ...
                <small>
                  A reason to wait, hold or open a fresh transaction review.
                </small>
              </span>
            </div>
            <p>
        ...
        <section className="home-how" aria-labelledby="how-title">
          <div className="home-how-heading">
            <div>
              <h2 id="how-title">
                Your lending. Your stock picks. One clear flow.
              </h2>
            </div>
          ...
          <ol>
            <li>
              ...
              <p>
                Connect your wallet and create a lending position. Freestock
                uses the Steakhouse USDG vault on Robinhood Chain.
              </p>
            </li>
            <li>
              ...
              <p>
                Pick NVIDIA, Apple, Tesla, Alphabet or SPY tokens. Split a
                purchase across a basket, or keep gains in your lending
                position.
              </p>
            </li>
            <li>
              ...
              <p>
                See the available budget, estimated gas and minimum tokens
                before you approve. Confirmed purchases link to their onchain
                receipt.
              </p>
            </li>
          </ol>
        ...
        <section className="home-demo-invitation">
          <div>
            ...
            <p>
              Choose a lending scenario, pick your stocks and decide how much to
              reinvest. Explore the results with simulated money before
              connecting a wallet.
            </p>
          </div>
